      ...
      <main className="relative bg-black min-h-screen">
        ...
        <div className="relative z-10">
          ...
          <section className="py-32">
            <div className="container mx-auto px-4 relative">
              <div className="grid md:grid-cols-2 gap-16 items-center">
                <div className="space-y-8 p-8 rounded-xl bg-black/40 backdrop-blur-sm border border-[#8B1F47]/10">
                  <h2 className="text-5xl font-bold text-white">
                    Who We <span className="text-[#8B1F47]">Are</span>
                  </h2>
                  <p className="text-gray-300 text-lg leading-relaxed">
                ...
                <div className="relative aspect-square rounded-2xl overflow-hidden group bg-black/40 backdrop-blur-sm border border-[#8B1F47]/10">
                  <Image
                    src="https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=2070"
                    alt="Our Team"
                    fill
                  ...
                  <form className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <input
                        type="text"
                        placeholder="Name And Surname*"
                        className="bg-gradient-to-br from-[#641434]/40 to-black/60 backdrop-blur-sm border border-[#8B1F47]/20 text-white px-6 py-4 rounded-lg w-full transition-all duration-300 placeholder:text-[#4A154B]/90 placeholder:font-medium hover:border-[#8B1F47]/40 hover:shadow-md hover:shadow-[#8B1F47]/10 focus:outline-none focus:border-[#8B1F47]/60 focus:ring-2 focus:ring-[#8B1F47]/20 focus:shadow-lg focus:shadow-[#8B1F47]/10 focus:bg-gradient-to-br focus:from-[#641434]/50 focus:to-black/70"
                        required
                      />
                      <input
                        type="email"
                    ...
                    <textarea
                      placeholder="Your Message*"
                      rows={6}
                      className="bg-gradient-to-br from-[#641434]/40 to-black/60 backdrop-blur-sm border border-[#8B1F47]/20 text-white px-6 py-4 rounded-lg w-full transition-all duration-300 placeholder:text-[#4A154B]/90 placeholder:font-medium hover:border-[#8B1F47]/40 hover:shadow-md hover:shadow-[#8B1F47]/10 focus:outline-none focus:border-[#8B1F47]/60 focus:ring-2 focus:ring-[#8B1F47]/20 focus:shadow-lg focus:shadow-[#8B1F47]/10 focus:bg-gradient-to-br focus:from-[#641434]/50 focus:to-black/70 resize-none"
                      required
                    ></textarea>
